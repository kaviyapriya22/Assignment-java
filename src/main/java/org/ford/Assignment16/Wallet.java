...
public class Wallet {
    ...
    @Min(value = 1000,message = "Minimum balance for the wallet account should be greater than 1000")
    private Double balance;

    @NotBlank(message = "Email is required")
    @Pattern(regexp = "^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$",message = "EX: abc@gmail.com")
